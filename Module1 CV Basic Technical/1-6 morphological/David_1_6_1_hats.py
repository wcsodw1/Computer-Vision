# USAGE
# python David_1_6_1_hats.py --image "../../../CV-PyImageSearch Gurus Course/Dataset/data/car.png"
# python David_1_6_1_hats.py --image "../../../CV-PyImageSearch Gurus Course/Dataset/data/AUS1.jpg"
