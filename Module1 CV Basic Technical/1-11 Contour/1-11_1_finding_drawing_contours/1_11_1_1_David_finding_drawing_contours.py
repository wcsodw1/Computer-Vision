# python David_1_11_1_finding_drawing_contours.py --image "../../../data/opencv_logo.png"
# python 1_11_1_1_David_finding_drawing_contours.py --image "../../../../CV-PyImageSearch Gurus Course/Dataset/data/basic_shapes.png"
