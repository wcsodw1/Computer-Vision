# USAGE
# python David_1_9_3_adaptive_thresholding.py --image "../../data/license_plate.png"
# python 1_9_3_David_adaptive_thresholding.py --image "../../../CV-PyImageSearch Gurus Course/Dataset/data/a.jpg"
