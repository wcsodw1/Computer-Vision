...
ap.add_argument("-a", "--approx-images", type=int, default= 100,
	help="Approximate # of images in the dataset")
ap.add_argument("-b", "--max-buffer-size", type=int, default= 1000,
	help="Maximum buffer size for # of features to be stored in memory")
    
import sys 

sys.argv[1:] = '-d ../../ukbench -f output/features.hdf5'.split()
