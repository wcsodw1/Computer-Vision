# -*- coding: utf-8 -*-
"""
Created on Thu Apr 23 21:32:15 2020

@author: user
"""

# python David_5_5_train_recognizer.py --selfies output/faces --classifier output/classifier --sample-size 100
# python David_5_5_train_recognizer.py
...
sys.argv[1:] = '-s output/faces -c output/classifier -n 100 '.split()
...
for (i, path) in enumerate(glob.glob(args["selfies"] + "/*.txt")):
	...
	name = path[path.rfind("/") + 7:].replace(".txt", "")
