# -*- coding: utf-8 -*-
"""
Created on Fri Apr 24 15:14:09 2020

@author: user
"""

# USAGE
# python David_5_5_gather_selfies.py --face-cascade ../cascades/haarcascade_frontalface_default.xml --output output/faces/david.txt
# python David_5_5_gather_selfies.py
...
#import sys 
#sys.path.append("pyimagesearch\\facedetector")
...
sys.argv[1:] = '-f ../cascades/haarcascade_frontalface_default.xml -o output/faces/david.txt '.split()
...
while True:
	...
	if len(faceRects) > 0:
		...
		cv2.circle(frame, (x+100, y+100), 130, (0, 0, 255), 3)
