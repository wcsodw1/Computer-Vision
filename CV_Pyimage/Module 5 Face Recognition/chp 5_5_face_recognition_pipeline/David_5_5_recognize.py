# -*- coding: utf-8 -*-
"""
Created on Thu Apr 23 21:41:50 2020

@author: user
"""

# python David_5_5_recognize.py --face-cascade ../cascades/haarcascade_frontalface_default.xml --classifier output/classifier
# python David_5_5_recognize.py


# import the necessary packages
from pyimagesearch.face_recognition.facedetector import FaceDetector
from pyimagesearch.face_recognition.facerecognizer import FaceRecognizer
import argparse
import imutils
import cv2
import sys
...
#sys.argv[1:] = '-f ../cascades/haarcascade_frontalface_default.xml -c output/classifier '.split()
sys.argv[1:] = '-f ../cascades/haarcascade_frontalface_default.xml -c output/classifier '.split()
...
while True:
	...
	for (i, (x, y, w, h)) in enumerate(faceRects):
		...
		#cv2.circle(frame, (x+w-100, y+h-100), x, (0, 0, 255), 2)
