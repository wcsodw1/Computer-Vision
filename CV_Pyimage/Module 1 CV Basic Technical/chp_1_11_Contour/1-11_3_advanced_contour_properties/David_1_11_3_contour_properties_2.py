# USAGE
# python David_1_11_3_contour_properties_2.py --image "../../../../CV-PyImageSearch Gurus Course/Dataset/data/coins02.png"
# python David_1_11_3_contour_properties_2.py --image "../../../../CV-PyImageSearch Gurus Course/Dataset/data/tetris_blocks.png"
...
import argparse
    ...
    # 1.2 load the Tetris block image, convert it to grayscale, and threshold the image
...
# image = cv2.imread("../../../data/coins02.png")
...
cv2.imshow("Thresh", thresh)
    ...
    # find external contours in the thresholded image and allocate memory for the convex hull image
cnts = cv2.findContours(thresh.copy(), cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE)
cnts = imutils.grab_contours(cnts)
hullImage = np.zeros(gray.shape[:2], dtype="uint8")
cv2.imshow("hullImage", hullImage)

# 2.loop over the contours
