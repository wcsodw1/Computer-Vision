# USAGE
# python David_1_4_8_masking.py --image "../../../CV-PyImageSearch Gurus Course/Dataset/data/3.jpg"
...
cv2.rectangle(mask, (50, 90), (350, 450), 255, -1)
...
# mask again
mask = np.zeros(image.shape[:2], dtype="uint8")
cv2.circle(mask, (250, 300), 250, 255, -1)
masked = cv2.bitwise_and(image, image, mask=mask)
cv2.imshow("Mask", mask)
cv2.imshow("Mask Applied to Image", masked)
cv2.waitKey(0)