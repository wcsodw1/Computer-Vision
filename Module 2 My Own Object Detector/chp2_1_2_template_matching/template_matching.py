# USAGE
# python template_matching.py --source "../../data/source_01.jpg" --template "../../data/template.jpg"
# python template_matching.py --source "../../data/AUS.JPG" --template "../../data/AUS_FACE.JPG"
