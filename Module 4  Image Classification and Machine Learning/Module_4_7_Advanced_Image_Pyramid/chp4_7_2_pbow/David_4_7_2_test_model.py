...
@author: user
"""
# python David_4_7_2_test_model.py --images output/data/testing --codebook output/vocab.cpickle --levels 2 \
...
for imagePath in imagePaths:
   ...
   Label0=imagePath.split("\\")[0] # output/data/testing
   Label1=imagePath.split("\\")[2] # Ex : motorbike
   Label2=imagePath.split("\\")[3] # Ex : image_0770.jpg
